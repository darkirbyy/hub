    ...
    protected function setConfigIndex(): array
    {
        return [
            'cols' => [
                // 0 => ['getter' => 'id'],
                1 => ['getter' => 'username'],
                2 => ['getter' => 'self', 'label' => 'imageFile', 'filters' => 'fmt_image_file("username","app-avatar-img app-avatar-container-xs")|raw'],
                3 => ['getter' => 'metaRole'],
    ...
    protected function setConfigShow(): array
    {
        return [
            'rows' => [
                ...
                8 => ['getter' => 'self', 'label' => 'imageFile', 'filters' => 'fmt_image_file("username", "app-avatar-img app-avatar-container-lg")|raw'],
