        ...
        return [
            'cols' => [
                ...
                2 => [
                    'getter' => 'self',
                    'label' => 'imageFile',
                    'filters' => 'get_image_path("default-avatar.png")|fmt_image_path("app-img-fluid app-avatar-img app-avatar-container-xs")|raw',
                ],
                3 => ['getter' => 'dateLastCo', 'filters' => 'format_datetime("medium", "medium")'],
                4 => ['getter' => 'dateUpdate', 'filters' => 'format_datetime("medium", "none")', 'breakpoint' => 'md'],
                5 => ['getter' => 'dateAdd', 'filters' => 'format_datetime("medium", "none")', 'breakpoint' => 'md'],
            ],
            'backlink' => [
        ...
        return [
            'rows' => [
                ...
                8 => [
                    'getter' => 'self',
                    'label' => 'imageFile',
                    'filters' => 'get_image_path("default-avatar.png")|fmt_image_path("app-img-fluid app-avatar-img app-avatar-container-lg")|raw',
                ],
